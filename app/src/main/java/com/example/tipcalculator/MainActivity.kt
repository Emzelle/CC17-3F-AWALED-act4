...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val roundSwitch: Switch = findViewById(R.id.roundSwitch)
        ...
        button.setOnClickListener {
            ...
            val tip: Double = when (selection) {
                ...
                R.id.radioButton3 -> price * 0.15
                    ...
                    Toast.makeText(this, "Please select a tip percentage", Toast.LENGTH_SHORT)
                        .show()
                    return@setOnClickListener
                }
            }
            ...
            val finalTip = if (roundSwitch.isChecked) {
